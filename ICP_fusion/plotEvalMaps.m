function plotEvalMaps(fusion_map, is_eval)
    if is_eval == 1
        ...
        nv_pointcloud = pointCloud(rand_pts, 'Color', (rand_nvs/5+0.8));
        ...
        cc_pointcloud = pointCloud(pts, 'Color', (cc_color));
        ...
        t_pointcloud = pointCloud(pts, 'Color', t_color/max(max(t_color)));
